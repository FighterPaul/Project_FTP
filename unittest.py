...
def run_command(input_side_effects, result_queue):
  try:
    ...
    results = []
    # for input_side_effect in input_side_effects:
    #   # process.stdin.write(input_side_effect)
    #   # process.stdin.flush()
    #   # output = process.stdout.readline()
    #   output = process.communicate(input_side_effect, timeout=2)
    #   outputs.append(output.decode().strip())
